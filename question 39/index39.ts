...
// Example usage:
const album1 = makeAlbum("talha", "open latter");
const album2 = makeAlbum("dinojams", "Album Title 2", 12); // Including the number of tracks
const album3 = makeAlbum("mosewala", "Album Title 3");
